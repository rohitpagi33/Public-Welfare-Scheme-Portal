...
// Get the filter status if it's set (default is 'all' to show all applications)
$filter_status = isset($_GET['status']) ? $_GET['status'] : 'all';

// Prepare the SQL query based on the selected status filter
if ($filter_status == 'all') {
    $sql = "SELECT * FROM applications";
} else {
    $sql = "SELECT * FROM applications WHERE status = '$filter_status'";
}
        ...
        <div class="filter-container">
            <form method="GET">
                ...
                <select name="status" id="status" onchange="this.form.submit()">
                    ...
                    <option value="rejected" <?php echo $filter_status == 'Cancelled' ? 'selected' : ''; ?>>Cancelled</option>
                </select>
            </form>
        </div>
...
<div class="applications-container">
    ...
    if ($result->num_rows > 0) {
        ...
        while ($application = $result->fetch_assoc()) {
            ...
            echo    '<td>' . $application['scheme_name'] . '</td>';
