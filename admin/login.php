...
$result=mysqli_query($con,"SELECT * FROM userdata WHERE uname='$Username'");
...
if (mysqli_num_rows($result) > 0) {
  ...
  echo "<script> alert('Username cannot match!!!');</script>";
}
}
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Admin Login - Ahemedabad Public Welfare Schemes</title>
